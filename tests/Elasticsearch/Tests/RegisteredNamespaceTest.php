...
class RegisteredNamespaceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testNonExistingNamespace()
    {
        ...
        $this->expectException(\Digistorm\Common\Exceptions\BadMethodCallException::class);
...
class FooNamespaceBuilder implements Digistorm\Namespaces\NamespaceBuilderInterface
{
