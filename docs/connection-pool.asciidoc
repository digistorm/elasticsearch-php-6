...
$client = ClientBuilder::create()
            ->setConnectionPool('\Digistorm\ConnectionPool\StaticNoPingConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Digistorm\ConnectionPool\StaticConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Digistorm\ConnectionPool\SimpleConnectionPool', [])
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setConnectionPool('\Digistorm\ConnectionPool\SniffingConnectionPool', [])
            ->build();
----
