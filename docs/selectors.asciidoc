...
$client = ClientBuilder::create()
            ->setSelector('\Digistorm\ConnectionPool\Selectors\RoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\Digistorm\ConnectionPool\Selectors\StickyRoundRobinSelector')
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSelector('\Digistorm\ConnectionPool\Selectors\RandomSelector')
            ->build();
----
