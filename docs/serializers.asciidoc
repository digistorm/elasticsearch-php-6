...
$client = ClientBuilder::create()
            ->setSerializer('\Digistorm\Serializers\SmartSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Digistorm\Serializers\ArrayToJSONSerializer');
            ->build();
----
...
----
$client = ClientBuilder::create()
            ->setSerializer('\Digistorm\Serializers\EverythingToJSONSerializer');
            ->build();
----
