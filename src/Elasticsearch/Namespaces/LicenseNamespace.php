...
class LicenseNamespace extends AbstractNamespace
{
     ...
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/6.7/get-license.html
     */
     ...
     * @param array $params Associative array of parameters
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/6.7/get-trial-status.html
     */
     ...
     * @param array $params Associative array of parameters
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/6.7/get-basic-status.html
     */
     ...
     * @param array $params Associative array of parameters
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/6.7/update-license.html
     */
     ...
     * @param array $params Associative array of parameters
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/6.7/start-basic.html
     */
     ...
     * @param array $params Associative array of parameters
     * @return array
     * @see https://www.elastic.co/guide/en/elasticsearch/reference/6.7/start-trial.html
     */
